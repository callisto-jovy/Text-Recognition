 ...
 public class SwingFXUtils {
     ...
     static BufferedImage createCompatibleBufferedImage(int w, int h) {
         ...
         switch (fxPixelsNativeFormat) {
             ...
             default:
                 throw new UnsupportedOperationException("unrecognized pixel format: " + fxPixelsNativeFormat);
         }
     }
     ...
     public static BufferedImage fromFXImage(Image img, BufferedImage bimg) {
         ...
         final int prefBimgType = getBestBufferedImageType(pr.getPixelFormat(), bimg);
         if (bimg != null) {
             final int bw = bimg.getWidth();
             final int bh = bimg.getHeight();
         ...
         final IntegerComponentRaster icr = (IntegerComponentRaster) bimg.getRaster();
         final int offset = icr.getDataOffset(0);
         final int scan = icr.getScanlineStride();
         final int[] data = icr.getDataStorage();
